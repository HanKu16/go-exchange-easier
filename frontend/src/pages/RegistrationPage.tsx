import { Grid, Box, Container, Typography, TextField, Alert,
  FormControlLabel, Checkbox, Link, Button, CircularProgress } from '@mui/material'
...
export const RegistrationPage = () => {
  ...
  const [wasRegistrationSuccessful, setWasRegistrationSuccessful] = useState<boolean>(false)
  ...
  const handleError = (error: ApiErrorResponse) => {
      ...
      if (errorFieldNames.length != 0) {
        setErrorMessage("Registration attempt failed. Check requirments for " + 
  ...
  const handleRegistration = async () => {
    ...
    if (!isAgreementAccepted) {
      setErrorMessage("Terms and Conditions must be accepted if you want to sign up")
      return
    }
