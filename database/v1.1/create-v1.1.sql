...
CREATE TABLE likes_on_university_reviews (
  university_review_id INTEGER NOT NULL,
  author_id INTEGER NOT NULL,
  PRIMARY KEY (university_review_id, author_id)
);

CREATE TABLE dislikes_on_university_reviews (
  university_review_id INTEGER NOT NULL,
  author_id INTEGER NOT NULL,
  PRIMARY KEY (university_review_id, author_id)
);
...
CREATE TABLE university_follows (
  university_follow_id BIGSERIAL PRIMARY KEY,
  follower_id INTEGER NOT NULL,
  university_id SMALLINT NOT NULL
);
...
ALTER TABLE likes_on_university_reviews ADD FOREIGN KEY (university_review_id) REFERENCES university_reviews (university_review_id);

ALTER TABLE likes_on_university_reviews ADD FOREIGN KEY (author_id) REFERENCES users (user_id);

ALTER TABLE dislikes_on_university_reviews ADD FOREIGN KEY (university_review_id) REFERENCES university_reviews (university_review_id);

ALTER TABLE dislikes_on_university_reviews ADD FOREIGN KEY (author_id) REFERENCES users (user_id);
