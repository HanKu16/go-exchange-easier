...
public class MessageController implements MessageApi {
    ...
    @Override
    public ResponseEntity<SimplePage<MessageDetails>> getPage(
            UUID roomId,
            Pageable pageable,
            AuthenticatedUser authenticatedUser
    ) {
        SimplePage<MessageDetails> page = messageService.getPage(roomId, authenticatedUser.getId(), pageable);
    ...
    public ResponseEntity<MessageDetails> create(
        ...
        MessageDetails message = messageService.create(roomId, request, authenticatedUser);
