...
public class CoreExceptionHandler {
    ...
    @ExceptionHandler({InvalidPrincipalTypeException.class, MissingDefaultRoleException.class,})
    ...
    @ExceptionHandler({MissingJwtClaimException.class, UserAccountRevokedException.class})
