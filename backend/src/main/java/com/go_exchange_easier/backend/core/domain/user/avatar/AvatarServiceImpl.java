...
public class AvatarServiceImpl implements AvatarService {
    ...
    public boolean delete(String originalKey) {
        return fileStorageService.delete(bucketProperties.getUser(), originalKey) &&
                fileStorageService.delete(bucketProperties.getUser(), getThumbnailKey(originalKey));
    }

    @Override
    public AvatarUrlSummary getUrl(String originalKey) {
        String originalAvatarUrl = fileStorageService.getPublicUrl(bucketProperties.getUser(), originalKey);
    ...
    private String getThumbnailKey(String originalKey) {
        ...
        return originalKey.substring(0, dotIndex) + "_small" + ".png";
    }
